...
# Output log file
log_file = r'/roberta_large_results.txt'  
...
with open(log_file, 'w') as f:  
    ...
    for epoch in range(epochs):
        ...
        for i, batch in enumerate(train_progress_bar):
            ...
            if step % 5000 == 0:
                torch.save(model.state_dict(), f'roberta_large/model_step_{step}.pth')
        ...
        if avg_val_loss < best_val_loss:
            ...
            patience_counter = 0
            torch.save(model.state_dict(), r'/roberta_large_best_model.pth')  # Save best model
        else:
            patience_counter += 1
    ...
    # Save final model
    torch.save(model.state_dict(), r'/roberta_large_final_model.pth')
