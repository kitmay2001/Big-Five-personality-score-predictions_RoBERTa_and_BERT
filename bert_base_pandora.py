...
# Output log file
log_file = r'/bert_base_result.txt' 
...
with open(log_file, 'w') as f:  
    ...
    for epoch in range(epochs):
        ...
        for i, batch in enumerate(train_progress_bar):
            ...
            if step % 5000 == 0:
                torch.save(model.state_dict(), f'bert_base/model_step_{step}.pth')
        ...
        if avg_val_loss < best_val_loss:
            ...
            patience_counter = 0
            torch.save(model.state_dict(), r'/bert_base_best_model.pth')  # Save best model
        else:
            patience_counter += 1
    ...
    # Save final model
    torch.save(model.state_dict(), r'/bert_base_final_model.pth')
